...
public class CommentAdapter extends BaseAdapter {
  private   List<CommentBean> mCommentList;
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        Glide.with(mContext).load(mCommentList.get(i).getAuthor().getAvatar().getTemplate("m")).crossFade().diskCacheStrategy(DiskCacheStrategy.ALL).into(mHolder.mCommenterAvatar);
        if (likesCount!=0){
